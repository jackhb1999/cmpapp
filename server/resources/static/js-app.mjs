...
import { importObject, setWasmExports } from './js-app.import-object.mjs'
...
const wasmFilePath = './js-app.wasm';
...
try {
  ...
  if (isBrowser) {
    wasmInstance = (await WebAssembly.instantiateStreaming(fetch(new URL('./js-app.wasm',import.meta.url).href), importObject, wasmOptions)).instance;
  }
} catch (e) {
